...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        await db.query(
            "INSERT INTO users (username, email, password_hash, role_id, company_id, verification_token, status) VALUES (?, ?, ?, ?, ?, ?, ?)",
            [username, email, passwordHash, role_id, company_id, verificationToken, 'inactive']
        );
...
const verifyEmail = async (req, res) => {
    ...
    try {
        ...
        await db.query("UPDATE users SET verified_at = NOW(), verification_token = NULL WHERE id = ?", [user.id]);
